...
import com.edu.sena.zentry.repository.TipoDocumentoRepository;
import com.edu.sena.zentry.service.dto.TipoDocumentoDTO;
import com.edu.sena.zentry.service.mapper.TipoDocumentoMapper;
...
class TipoDocumentoResourceIT {
    ...
    private static final String DEFAULT_NOMBRE_TIPO_DOCUMENTO = "AAAAAAAAAA";
    private static final String UPDATED_NOMBRE_TIPO_DOCUMENTO = "BBBBBBBBBB";
    ...
    public static TipoDocumento createEntity() {
        return new TipoDocumento().nombreTipoDocumento(DEFAULT_NOMBRE_TIPO_DOCUMENTO);
    }
    ...
    public static TipoDocumento createUpdatedEntity() {
        return new TipoDocumento().nombreTipoDocumento(UPDATED_NOMBRE_TIPO_DOCUMENTO);
    }
    ...
    void getAllTipoDocumentos() throws Exception {
        ...
        restTipoDocumentoMockMvc
            ...
            .andExpect(jsonPath("$.[*].nombreTipoDocumento").value(hasItem(DEFAULT_NOMBRE_TIPO_DOCUMENTO)));
    }
    ...
    void getTipoDocumento() throws Exception {
        ...
        restTipoDocumentoMockMvc
            ...
            .andExpect(jsonPath("$.nombreTipoDocumento").value(DEFAULT_NOMBRE_TIPO_DOCUMENTO));
    }
    ...
    void putExistingTipoDocumento() throws Exception {
        ...
        updatedTipoDocumento.nombreTipoDocumento(UPDATED_NOMBRE_TIPO_DOCUMENTO);
    ...
    void fullUpdateTipoDocumentoWithPatch() throws Exception {
        ...
        partialUpdatedTipoDocumento.nombreTipoDocumento(UPDATED_NOMBRE_TIPO_DOCUMENTO);
