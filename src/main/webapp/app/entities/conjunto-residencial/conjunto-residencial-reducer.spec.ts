...
import reducer, {
  ...
  reset,
  updateEntity,
} from './conjunto-residencial.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONJUNTORESIDENCIAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONJUNTORESIDENCIAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONJUNTORESIDENCIAL actions', async () => {
      const arg = { id: '363bceec-d9d6-4679-92fa-c40c495dcc90' };
    ...
    it('dispatches UPDATE_CONJUNTORESIDENCIAL actions', async () => {
      const arg = { id: '363bceec-d9d6-4679-92fa-c40c495dcc90' };
    ...
    it('dispatches PARTIAL_UPDATE_CONJUNTORESIDENCIAL actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CONJUNTORESIDENCIAL actions', async () => {
      const arg = 42666;
