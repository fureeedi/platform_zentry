...
import { IServicio, defaultValue } from 'app/shared/model/servicio.model';
import { EntityState } from 'app/shared/reducers/reducer.utils';

import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './servicio.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IServicio> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICIO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICIO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICIO actions', async () => {
      const arg = { id: 'f26ff2e6-1515-4716-8fc5-02503d36a346' };
    ...
    it('dispatches UPDATE_SERVICIO actions', async () => {
      const arg = { id: 'f26ff2e6-1515-4716-8fc5-02503d36a346' };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICIO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_SERVICIO actions', async () => {
      const arg = 42666;
