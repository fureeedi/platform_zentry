...
import reducer, {
  ...
  reset,
  updateEntity,
} from './servicio-conjunto.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICIOCONJUNTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICIOCONJUNTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICIOCONJUNTO actions', async () => {
      const arg = { id: 'ea1f8bd9-a980-4d3d-af98-37c3d729cd6a' };
    ...
    it('dispatches UPDATE_SERVICIOCONJUNTO actions', async () => {
      const arg = { id: 'ea1f8bd9-a980-4d3d-af98-37c3d729cd6a' };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICIOCONJUNTO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_SERVICIOCONJUNTO actions', async () => {
      const arg = 42666;
