...
import reducer, {
  ...
  reset,
  updateEntity,
} from './administrador-conjunto.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMINISTRADORCONJUNTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADMINISTRADORCONJUNTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADMINISTRADORCONJUNTO actions', async () => {
      const arg = { id: '2c6dbeab-0c90-4768-80d2-0bb202869edc' };
    ...
    it('dispatches UPDATE_ADMINISTRADORCONJUNTO actions', async () => {
      const arg = { id: '2c6dbeab-0c90-4768-80d2-0bb202869edc' };
    ...
    it('dispatches PARTIAL_UPDATE_ADMINISTRADORCONJUNTO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_ADMINISTRADORCONJUNTO actions', async () => {
      const arg = 42666;
