...
import reducer, {
  ...
  reset,
  updateEntity,
} from './vinculado-inmueble.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VINCULADOINMUEBLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VINCULADOINMUEBLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VINCULADOINMUEBLE actions', async () => {
      const arg = { id: 'f3479de1-757f-46c8-99b3-cc5dcb0774f3' };
    ...
    it('dispatches UPDATE_VINCULADOINMUEBLE actions', async () => {
      const arg = { id: 'f3479de1-757f-46c8-99b3-cc5dcb0774f3' };
    ...
    it('dispatches PARTIAL_UPDATE_VINCULADOINMUEBLE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_VINCULADOINMUEBLE actions', async () => {
      const arg = 42666;
