...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACTURADEPAGO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FACTURADEPAGO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FACTURADEPAGO actions', async () => {
      const arg = { id: '9a25f71f-28bf-40a5-b14b-2e14522531f2' };
    ...
    it('dispatches UPDATE_FACTURADEPAGO actions', async () => {
      const arg = { id: '9a25f71f-28bf-40a5-b14b-2e14522531f2' };
    ...
    it('dispatches PARTIAL_UPDATE_FACTURADEPAGO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_FACTURADEPAGO actions', async () => {
      const arg = 42666;
