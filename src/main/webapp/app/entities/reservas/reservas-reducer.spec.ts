...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './reservas.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESERVAS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESERVAS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESERVAS actions', async () => {
      const arg = { id: 'c8dc3799-9d80-4f94-8ba1-d6cfc2904cc9' };
    ...
    it('dispatches UPDATE_RESERVAS actions', async () => {
      const arg = { id: 'c8dc3799-9d80-4f94-8ba1-d6cfc2904cc9' };
    ...
    it('dispatches PARTIAL_UPDATE_RESERVAS actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_RESERVAS actions', async () => {
      const arg = 42666;
