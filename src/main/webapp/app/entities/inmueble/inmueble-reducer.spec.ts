...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './inmueble.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INMUEBLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INMUEBLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INMUEBLE actions', async () => {
      const arg = { id: 'aac20b9f-f3ab-4368-87e6-341753a78d64' };
    ...
    it('dispatches UPDATE_INMUEBLE actions', async () => {
      const arg = { id: 'aac20b9f-f3ab-4368-87e6-341753a78d64' };
    ...
    it('dispatches PARTIAL_UPDATE_INMUEBLE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_INMUEBLE actions', async () => {
      const arg = 42666;
