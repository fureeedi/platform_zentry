...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './anuncios.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_ANUNCIOS actions', async () => {
      const arg = { id: '1384a39a-a9bb-42f4-8305-c4068c135fdc' };
