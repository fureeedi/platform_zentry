...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './vinculado.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VINCULADO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VINCULADO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VINCULADO actions', async () => {
      const arg = { id: 'f8fc23e9-dfcd-41bf-a408-285a1240aeb5' };
    ...
    it('dispatches UPDATE_VINCULADO actions', async () => {
      const arg = { id: 'f8fc23e9-dfcd-41bf-a408-285a1240aeb5' };
    ...
    it('dispatches PARTIAL_UPDATE_VINCULADO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_VINCULADO actions', async () => {
      const arg = 42666;
